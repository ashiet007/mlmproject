        ...
        <div class="container">
            <div class="inner-sec-w3layouts py-lg-5 heading-padding py-3">
                <h3 class="tittle text-center mb-md-5 mb-4">Mobile Verification</h3>
                    <form class="form-horizontal" method="POST" action="{{ route('verification.verifyOtp') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-2 col-md-offset-4">
                                ...
                                <a class="btn btn-success" id="resend" href="{{ route('verification.verificationForm') }}">
...
(function(){
  ...
  setInterval(function() {
    ...
    if (counter === 0) {
       $('#resend').attr('href','{{ route('verification.verificationForm') }}');
